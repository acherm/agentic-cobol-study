       ...
       01  TARGET-VALUE     PIC 9.99 VALUE 0.15.

       01  WIN-TABLE.
           05  WIN-LINE     PIC 9 OCCURS 3 TIMES
               OCCURS 8 TIMES.
           MOVE 2 TO WIN-LINE(1,1)
           MOVE 9 TO WIN-LINE(2,1)
           MOVE 4 TO WIN-LINE(3,1)
           MOVE 7 TO WIN-LINE(1,2)
           MOVE 5 TO WIN-LINE(2,2)
           MOVE 3 TO WIN-LINE(3,2)
           MOVE 6 TO WIN-LINE(1,3)
           MOVE 1 TO WIN-LINE(2,3)
           MOVE 8 TO WIN-LINE(3,3)
           MOVE 2 TO WIN-LINE(1,4)
           MOVE 7 TO WIN-LINE(2,4)
           MOVE 6 TO WIN-LINE(3,4)
           MOVE 9 TO WIN-LINE(1,5)
           MOVE 5 TO WIN-LINE(2,5)
           MOVE 1 TO WIN-LINE(3,5)
           MOVE 4 TO WIN-LINE(1,6)
           MOVE 3 TO WIN-LINE(2,6)
           MOVE 8 TO WIN-LINE(3,6)
           MOVE 2 TO WIN-LINE(1,7)
           MOVE 5 TO WIN-LINE(2,7)
           MOVE 8 TO WIN-LINE(3,7)
           MOVE 4 TO WIN-LINE(1,8)
           MOVE 5 TO WIN-LINE(2,8)
           MOVE 6 TO WIN-LINE(3,8)
       ...
       INIT-NUM-DISPLAY.
           MOVE 0.01 TO WS-NUM-DISP(1)
           MOVE 0.02 TO WS-NUM-DISP(2)
           MOVE 0.03 TO WS-NUM-DISP(3)
           MOVE 0.04 TO WS-NUM-DISP(4)
           MOVE 0.05 TO WS-NUM-DISP(5)
           MOVE 0.06 TO WS-NUM-DISP(6)
           MOVE 0.07 TO WS-NUM-DISP(7)
           MOVE 0.08 TO WS-NUM-DISP(8)
           MOVE 0.09 TO WS-NUM-DISP(9).
